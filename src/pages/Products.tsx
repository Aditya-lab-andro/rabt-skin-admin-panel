...
const products = [
  ...
  { id: 2, name: 'Rose & Aloe Vera Moisturizer', category: 'Moisturizers', price: '₹320', stock: 85, status: 'Active', image: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=100&h=100&fit=crop' },
